...
$cssTool = $ws->paramGet($ws->paramGet('APP_NAME') . '_RELA_TEMPLATES_CSS_DIR') . 'template_outil.css';
$pageControl = $connect->constructHref($ws->paramGet('APP_CODE'),  'ctrl_connect');
...
$ws->assign('cssTool', $cssTool);
$ws->assign('pageControl', $pageControl);
