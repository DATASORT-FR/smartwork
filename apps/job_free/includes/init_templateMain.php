...
// Left Side zone
//$randCompanies = new JF_randCompanies();
//$ws->assign('CompaniesBlock', $randCompanies->display());

$jobnameSide = new JF_JobnameSide();
$jobnameSideBlock = $jobnameSide->display();
$ws->assign('JobnameSideBlock', $jobnameSideBlock);
