<?php
/**
* This file contains classes and functions for article administration
*
* @package    use_admarticle
...
*/
class object_admarticle extends BUS_object
{
	private $_client;
	...
	*/
	public function display($id) {
		...
		try {
			$line = array();
			$return = $this->_client->getArticle($id);
			$line = get_object_vars($return);
	...
	*/
	public function insert($argArray, $dbName = '') {
		...
		try {
			$id = $this->_client->setArticle($argArray);
