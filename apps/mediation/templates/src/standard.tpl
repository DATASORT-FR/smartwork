...
<header id="header-page" class="{$classPage|default:''}">
	<div id="surheader">
		<div class="contenu">
			<nav class="header1">
				<button class="nav-button navbar-toggler pull-right" type="button" data-bs-toggle="collapse" data-target="#menu-small">
					☰
				</button>
				<div class="menu-header1">
					{$MenuHeader1}
					{if $flagConnect}
						<a class="nav-link contactus" href="{$LinkLogin|default:'./login.php'}">{$nameConnect}
						</a>					 
					{else}
						<a class="nav-link contactus" href="{$LinkLogin|default:'./login.php'}">{#Txt_connect#}
						</a>
					{/if}
				</div>
				<div id="menu-small" class="collapse" aria-expanded="false">
					<a class="nav-link menu-home" href="{$LinkHome|default:'/'}" >
						{#Txt_home#}
					</a>
					{$MenuNav}
					{$MenuHeader2}
...
<div id="content-page" class="{$classPage|default:''}">
	<nav class="navbar navigation-zone">
	...
	<div class="container-fluid main-zone">
		...
		{if $RightSideDisplay|default:0 == 1}
			{if $LeftSideDisplay|default:0 == 1}
				<div class="col-sm-12 col-md-12 col-lg-4 order-lg-2 content-zone">
			{else}
				<div class="col-sm-12 col-md-12 col-lg-8 order-lg-1 content-zone">
			{/if}
				<div class="row">			
			...
			{if $LeftSideDisplay|default:0 == 1}
				<div class="col-sm-12 col-md-12 col-lg-4 order-lg-3 right-zone"> 
			{else}
				<div class="col-sm-12 col-md-12 col-lg-4 order-lg-2  right-zone"> 
			{/if}
		...
		{else}
			...
			{if $LeftSideDisplay|default:0 == 1}
				<div class="col-sm-12 col-md-12 col-lg-4 order-lg-1">
					{block name=LeftSide}
					{/block}
				</div>
			{/if}	
