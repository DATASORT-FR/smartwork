...
$articleCode = ECONOMY_CODE;
$categoryValue = ECONOMY_CATEGORY;
$classPage = ECONOMY_CLASS;
$filePath = $ws->paramGet($ws->paramGet('APP_NAME') . '_PAGES_DIR') . 'list-calculate.php';
require_once($filePath);

$connect = new object_connect();
$articlesLink = $connect->constructHref($ws->paramGet('APP_CODE'), 'mediation-economie-detail');
