...
$articleCode = JUDICIAL_CODE;
$categoryValue = JUDICIAL_CATEGORY;
$classPage = JUDICIAL_CLASS;
$filePath = $ws->paramGet($ws->paramGet('APP_NAME') . '_PAGES_DIR') . 'list-calculate.php';
require_once($filePath);

$connect = new object_connect();
$articlesLink = $connect->constructHref($ws->paramGet('APP_CODE'), 'mediation-judiciaire-detail');
