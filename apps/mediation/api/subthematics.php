...
if ($ws->cacheCtrl('subthematics')) {
	$subThematicList = $ws->cacheGet('subthematics');
}
else {
	...
	$subThematicList = $list;
	$ws->cacheSet('subthematics', $subThematicList);
}
echo json_encode($subThematicList);
