<?php
/**
* This file contains classes and function for the "variable categories" management.
*
...
*/
class object_variable_category extends BUS_object
{
	...
	*/
    public function __construct()
    {
		...
		$this->tableSet('dmg_variable_category');
		$this->joinTableSet('dmg_domain', 'id','dmg_variable_category','domain_id');
    ...
    public static function _copy($categoryId, $newDomainId, $newName = '') {
		...
		if (empty($category)) {
			...
			$tbCategory = new Smart_record('dmg_variable_category', 'dgm');
    ...
    public function organizeSequence($domainId)
    {
		...
		$tbCategory_item = new Smart_record('dmg_variable_category', 'dgm');
		$sequence = 1;
