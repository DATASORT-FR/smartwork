<?php
/**
* This file contains classes and function for the results content management.
*
* @package    use_processus
...
/**
* Classes for the processus content management.
*/
class object_content_results extends BUS_object
{

	/**
	* constructor processus
    *
    * @access public
	*/
