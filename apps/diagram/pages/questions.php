...
if ($domainId != '') {
	...
	$wcrud = new wcrud('object_question', $ws->extractPage(__FILE__), 'questions');
	...
	$wlist->deletecolumnnameSet('label'); /* column used in the delete confirmation window in the title */
