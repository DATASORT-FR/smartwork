			...
			<div class="container">
				<figure class="navbar-logo">
					<a href="{$LinkHome|default:''}">
						...
						<img class="notop" src="./images/separation/icon-planete_separation.svg" alt="Tout savoir sur ma séparation, mon divorce" title="Divorcer ou se séparer, un diagnostic complet">
					</a>
				</figure>
