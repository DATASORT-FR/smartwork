...
{block name=Main}
	<div class="container">
		<div class="block-ws content-update block-main" box-id="content" box-model="box-model" link_href="{$content_linkList|default:''}">
