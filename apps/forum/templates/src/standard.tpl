            ...
            <div class="container ">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
						...
						<li><a href="{$LinkForum|default:''}" class="nav-item nav-link home-link">{#Mnu_forum#}</a></li>
						...
						{if $flagAdmin}
							<li><a href="{$LinkStatistics|default:''}" class="nav-item nav-link">{#Mnu_statistic#}</a></li>
						{/if}
