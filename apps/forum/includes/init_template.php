...
$ws->assign('LinkDiagnostic', $connect->constructHref('SEPARATION', 'diagnostic', 'fullpath:true'));
$ws->assign('LinkStatistics', $connect->constructHref($ws->paramGet('APP_CODE'), 'data_statistics'));
$ws->assign('LinkSubjects', $connect->constructHref($ws->paramGet('APP_CODE'), 'subjects'));
...
$ws->assign('LinkPartenaires', $connect->constructHref('SEPARATION', 'partenaires', 'fullpath:true'));
$ws->assign('LinkCookies', $connect->constructHref('SEPARATION', 'cookies', 'fullpath:true'));
$ws->assign('LinkCGU', $connect->constructHref('SEPARATION', 'cgu', 'fullpath:true'));
$ws->assign('LinkConfidentialite', $connect->constructHref('SEPARATION', 'confidentialite', 'fullpath:true'));
$ws->assign('LinkMentionsLegales', $connect->constructHref('SEPARATION', 'mentions_legales', 'fullpath:true'));
$ws->assign('LinkSiteMap', $connect->constructHref('SEPARATION', 'sitemap', 'mode:xml', 'fullpath:true'));

$ws->assign('LinkOutil', $connect->constructHref('SEPARATION', 'outil', 'fullpath:true'));
