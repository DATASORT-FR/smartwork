...
// ====================================
	...
	if (defined('APP_CONTENT_DSN')) {
		$ws->paramSet('APP_CONTENT_DSN', CONTENT_DSN);
		$ws->paramSet('APP_CONTENT_USERNAME', CONTENT_USERNAME);
		$ws->paramSet('APP_CONTENT_PASSWORD', CONTENT_PASSWORD);
		$ws->paramSet('APP_CONTENT_MODEL_FILE', CONTENT_MODEL_FILE);
		$ws->paramSet('APP_CONTENT_SCHEMA_FILE', CONTENT_SCHEMA_FILE);
	}
	else {
	...
	if (defined('APP_FORUM_DSN')) {
		$ws->paramSet('APP_FORUM_DSN', FORUM_DSN);
		$ws->paramSet('APP_FORUM_USERNAME', FORUM_USERNAME);
		$ws->paramSet('APP_FORUM_PASSWORD', FORUM_PASSWORD);
		$ws->paramSet('APP_FORUM_MODEL_FILE', FORUM_MODEL_FILE);
		$ws->paramSet('APP_FORUM_SCHEMA_FILE', FORUM_SCHEMA_FILE);
	}
	else {
