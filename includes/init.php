...
define('JQUERY_ROOT', 'jquery-3.6.0/');
...
define('SMARTY_ROOT', 'smarty-4.1.1/');
define('TETHER_ROOT', 'tether-1.4.0/');
define('WORKSPACE_ROOT', 'workspace-1.0.3/');
...
// ====================================
	...
	require_once(SITE_ROOT_DIR . LIBS_PATH . WORKSPACE_ROOT . 'use_workspace.php');
	...
	require_once(SITE_ROOT_DIR . LIBS_PATH . 'contentlib.php');
	...
	$ws->paramSet('RELA_WORKSPACE_DIR', $ws->paramGet('RELA_LIBS_DIR') . WORKSPACE_ROOT);
...
// ====================================
	...
	require_once($ws->paramGet('MODULES_DIR') . 'index.php');

	// Plugins initialization
	require_once($ws->paramGet('PLUGINS_DIR') . 'index.php');
// ====================================
// Params
// ====================================
...
// ====================================
	...
	// Favicon
	$filePath = $ws->paramGet($ws->paramGet('APP_NAME') . '_DIR') . 'favicon.ico';
	if (file_exists($filePath)) {
		$ws->faviconSet(RELA_PATH . APPS_PATH . $ws->paramGet('APP_NAME'). '/' . 'favicon.ico');
	}
	else {
