{if $readonly==false}
	...
	<div id="{$field_id}_Container" class="video_container {$field_class}">
		<input id="{$field_id}" type="hidden" class="img_input" name="{$field_name}" value="{$field_value.value}">
		<div class="img_container_preview col-sm-3">
			<img id="{$field_id}_Image" class="img_preview" alt="" src="{$field_value.value}" onerror="this.src = './plugins/image/images/notfound.png';">
		</div>
		<div class="img_container_all col-sm-9">
			<div class="img_container_img row">
