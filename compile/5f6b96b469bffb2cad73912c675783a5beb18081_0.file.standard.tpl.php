...
/* Smarty version 4.1.1, created on 2022-12-09 18:39:21
  from 'E:\xampp\htdocs\smartwork\apps\forum\templates\src\standard.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_639372c9c7bd90_75638742',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5f6b96b469bffb2cad73912c675783a5beb18081' => 
    array (
      0 => 'E:\\xampp\\htdocs\\smartwork\\apps\\forum\\templates\\src\\standard.tpl',
      1 => 1646352325,
      2 => 'file',
    ),
  ),
...
function content_639372c9c7bd90_75638742 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
	...
	<?php } else { ?>
		<?php
$__section_idx_1_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['filecss']->value) ? count($_loop) : max(0, (int) $_loop));
...
>	
	<meta name="google-site-verification" content="JDk4rpMxYyL-4J8Ihr9-4TbX1gqbqDCr1Fofh0Rc1BM" />
</head>
...
" class="nav-item nav-link home-link"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'Mnu_forum');?>
</a></li>
...
" class="nav-item nav-link"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'Mnu_diagnostic');?>
						...
						<?php if ($_smarty_tpl->tpl_vars['flagAdmin']->value) {?>
							<li><a href="<?php echo (($tmp = $_smarty_tpl->tpl_vars['LinkStatistics']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" class="nav-item nav-link"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'Mnu_statistic');?>
</a></li>
						<?php }?>
...
">
		<div class="container">
			<figure class="content-image">
				<img src="./images/separation/forum/forum-banner.png" alt="Tout savoir sur ma séparation, mon divorce" title="Divorcer ou se séparer, le forum">
			</figure>
		</div>	
		<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_391631286639372c9c750b1_13428364', 'Main');
?>
...
<?php if ($_smarty_tpl->tpl_vars['combineFlag']->value) {?>
	...
	<?php }?>
	<?php
$__section_idx_2_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['fileOnejs']->value) ? count($_loop) : max(0, (int) $_loop));
...
<?php }
/* {block 'Main'} */
class Block_391631286639372c9c750b1_13428364 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'Main' => 
  array (
    0 => 'Block_391631286639372c9c750b1_13428364',
  ),
);
